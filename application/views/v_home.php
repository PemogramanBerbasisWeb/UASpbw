...
<body>
  ...
  <header id="header">
    ...
    <h1>BERITA TER-UPDATE</h1>
     <h3>SEPUTAR UNIVERSITAS TRUNOJOYO MADURA</h3>
          ...
          <div class="carousel-item active">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2>Portal Berita UTM</h2>
		   					<h3><p>Ayo!!! Kuliah Di UTM</p></h3>
    ...
    <section id="about">
      <div class="container">
        ...
        <header class="section-header">
          <h3>NEWS BERITA UTM</h3>
          <p>BERITA SEPUTAR UTM DAN PRESTASI MAHASISWA
			</p>
        </header>
...
<!--            
  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong>PORTAL BERITA UTM</strong>. All Rights Reserved
      </div>
